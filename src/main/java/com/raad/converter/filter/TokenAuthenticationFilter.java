package com.raad.converter.filter;

import com.raad.converter.security.TokenBasedAuthentication;
        ...
        if (authToken != null) {
            ...
            if (username != null) {
                ...
                TokenBasedAuthentication authentication =
                        new TokenBasedAuthentication(this.userDetailsService.loadUserByUsername(username));
