...
public class Hnc2String {
	...
	public static final String[] map = new String[65536]; // max : 0xFFFF

	static {

		Pattern P = Pattern.compile("0x([0-9a-f]{4})\\s*=>\\s*\\[" + "0x([0-9a-f]{4})"
			+ "(?:,\\s*0x([0-9a-f]{4}))?" + "(?:,\\s*0x([0-9a-f]{4}))?" + "\\]", Pattern.CASE_INSENSITIVE);
